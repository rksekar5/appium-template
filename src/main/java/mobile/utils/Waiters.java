...
public class Waiters {
   ...
   *
   * @param mobileElement static way -> await().atMost(10,
   *     SECONDS).atLeast(1,SECONDS).until(mobileElement::isDisplayed);
   */
   ...
   */
  @Step
  public static void waitUntilValueWillBePresentInElement(
      MobileElement mobileElement, String text) {
    log.trace("Waiting for element \"{}\" to be clickable", mobileElement);
